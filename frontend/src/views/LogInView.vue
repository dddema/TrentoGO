...
<template>
  <div class="bg-red flex flex-col justify-start items-center p-4">
    ...
    <div class="h-full flex flex-col justify-end pb-5 items-center">
      ...
      <RoundButton @button-click="googleSignIn" text="Accedi o Continua come Ospite" color="bg-trento-blue/30" text-color="text-trento-blue" hover-color="hover:bg-dark-trento-blue/40" class="mb-5"/>
